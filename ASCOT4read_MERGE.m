...
fast2 = '/home/andrea/TRANSP/TRANSP_analysis_script/RUNS/29210/O22/29210O22_fi_6.cdf';
...
%[EQD] = read_eqdsk('/home/andrea/ascot5/python/a5py/a5py/preprocessing/29909EQDSK.eqdsk',0);
...
%%%%%%%%%%%%% ASCOT 4 %%%%%%%%%%%%%%%%%%%%%
ascot4_SS_FO = load('/home/andrea/ascot5/TRAINING_SESSION/Ascot4_fortran/29210/SS/SS_D.h5');
dist4a_SS_FO = squeeze(ascot4_SS_FO.distributions.rzPitchEdist.ordinate)./6.242e18;
dist4adresso_SS_FO = reshape(permute(dist4a_SS_FO, [4,3,2,1]), [75, 50, 6771]);
ascot4_SS_GC = load('/home/andrea/ascot5/TRAINING_SESSION/Ascot4_fortran/29210/SS/ascot.h5');
dist4a_SS_GC = squeeze(ascot4_SS_GC.distributions.rzPitchEdist.ordinate)./6.242e18;
dist4adresso_SS_GC = reshape(permute(dist4a_SS_GC, [4,3,2,1]), [75, 50, 6771]);

ascot4_SW_FO = load('/home/andrea/ascot5/TRAINING_SESSION/Ascot4_fortran/29210/SW/SW_FO/ascot.h5');
dist4a_SW_FO = squeeze(ascot4_SW_FO.distributions.rzPitchEdist.ordinate)./6.242e18;
dist4adresso_SW_FO = reshape(permute(dist4a_SW_FO, [4,3,2,1]), [75, 50, 6771]);
ascot4_SW_GC = load('/home/andrea/ascot5/TRAINING_SESSION/Ascot4_fortran/29210/SW/ascot.h5');
dist4a_SW_GC = squeeze(ascot4_SW_GC.distributions.rzPitchEdist.ordinate)./6.242e18;
dist4adresso_SW_GC = reshape(permute(dist4a_SW_GC, [4,3,2,1]), [75, 50, 6771]);
return
dist4adressogc = dist4adresso_SW_GC + dist4adresso_SS_GC;
dist4adressofo = dist4adresso_SW_FO + dist4adresso_SS_FO;




pitch4 = ascot4_SS.distributions.rzPitchEdist.abscissae.dim3;
energy4 = ascot4_SS.distributions.rzPitchEdist.abscissae.dim4.*6.242e18;
...
subplot(1,3,3)
pcolor(X,Y, 100.*(1-(FIDDAFO./1)./(FIDDAGC./1)))
hold on
plot(EQD.LCFS_R.*100, EQD.LCFS_Z.*100, 'linewidth',2,'k')
hold on
plot(RSURF(:,69), ZSURF(:,69), 'linewidth',2,'r')
